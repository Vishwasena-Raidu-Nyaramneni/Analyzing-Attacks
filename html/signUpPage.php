...
<div class="w3-top">
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    <!-- <a href="passwordGenerator.html" class="w3-bar-item w3-button w3-padding-large">Password Generator</a> -->
    <a href="passwordStrengthChecker.html" class="w3-bar-item w3-button w3-padding-large">Password Strength Checker</a>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  ...
  <input type="text" name="f_name" id="Firstname" placeholder="Enter First Name"><br><br>
  <label for="Lastname">Last Name :</label><br>
  <input type="text" name="l_name" id="Lastname" placeholder="Enter Last Name"><br><br>
  <label for="password">Password: </label><br>
  <input type="text" name="password" id="password" placeholder="Password">
  <br><br>
  <!-- <p class="w3-xlarge">Template by w3.css</p> -->
  <a href="loginPage.html"><button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" name="signup_btn">Create Account</button></a>
  <br>
  </form>
  <br>
